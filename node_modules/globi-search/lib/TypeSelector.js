...
extend(TypeSelector.prototype, {
    ...
    update: function(search) {
        console.log('provided:' + JSON.stringify(search));
        console.log('pre:' + JSON.stringify(this.settings));
        this.settings['startValue'] = search.interactionType;
        console.log('post:' + JSON.stringify(this.settings));
