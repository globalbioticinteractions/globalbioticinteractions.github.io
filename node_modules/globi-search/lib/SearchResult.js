    ...
    showList: function(data, downloadlinks) {
        ...
        if (data.length > 0) {
            ...
            var linkRefs = downloadlinks.map(function(link) {
                return '<a href="' + link.url + '" class="link" title="download up to 4096 records as ' + link.resultType + ' file">download details</a>';
            }).join(' ');
            tableHead.innerHTML = [
                '<tr><th class="source-cell"></th>',
                ('<th></th>'),
                '<th class="target-cell">' + linkRefs + '</th></tr>',
                '<tr>',
            ...
            me.el.innerHTML = '<p>No interaction data was found with your criteria. Bummer!</p>' +
                '<br/><p>Suggest to make your search more general (e.g. Aves eats Insecta), increase your search area or <a href="https://github.com/jhpoelen/eol-globi-data/wiki/How-to-Contribute-Data-to-Global-Biotic-Interactions%3F">contribute more data</a>.</p>' +
