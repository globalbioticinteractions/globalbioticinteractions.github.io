...
function Bundle (opts) {
    var me = this;
    if (!(this instanceof Bundle)) return new Bundle(opts);
    this.opts = opts;
...
Bundle.prototype.appendTo = function (target) {
    ...
    this.emit('append', this.opts.target);
};

Bundle.prototype.draw = function() {
    this.opts.target.innerHTML ='';
    _buildBundles(this.opts.target, this.opts.json, this.opts.canvasDimension)
};
