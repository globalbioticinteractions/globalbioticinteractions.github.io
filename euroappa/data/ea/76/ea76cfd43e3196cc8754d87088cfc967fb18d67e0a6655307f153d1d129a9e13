**Butterfly Data Management Plan Meeting Minutes**
...
**Attendees:**  
Laura Elisabet Drivdal (LD),Nilgun Kulan (NK), Lorraine Balaine (LB), Jeroen van der Sluijs (JvdS), Jorrit Poelen (JP)

**Absent:** Mirella, Cala, Nicholas.

**Link to DMP:** 

[https://docs.google.com/document/d/1eRsXw-bSWmz9mI1v1HHKdJez11sbjTsBtWsknAdkDF0/edit?tab=t.0](https://docs.google.com/document/d/1eRsXw-bSWmz9mI1v1HHKdJez11sbjTsBtWsknAdkDF0/edit?tab=t.0)
...
\* review current draft DMP 

**Notes:**

Laura is planning to add previous meeting notes to this document. 

Laura submits DMP to reviewers (Ivan Meeus, Kjersti Hasle Enerstvedt) on Friday 8 Aug 2025 

Jorrit shared a [https://globalbioticinteractions.org/euroappa](https://globalbioticinteractions.org/euroappa) page on which the DMP draft and meeting notes are linked and versioned. Jeroen noted that we should check whether the DMP and associated meeting notes are suited to be openly accessible.

The attendees went over the DMP draft and had various discussions updating the draft accordingly.

Reviewers will be asked to provide feedback within 10 days (Monday, August 18). Nilgun will send a poll to find the next meeting day within that week (Aug. 19-22).

\----------

\[insert July meeting notes here\]
...
**Attendees:**  
Laura Elisabet Drivdal (LD), Nicola Gallai (NG), Nilgun Kulan (NK), Lorraine Balaine (LB), Jeroen van der Sluijs (JvdS), Jorrit Poelen (JP)
...
* Polling: [https://framadate.org/NgnXl51S1sJMoJ2J](https://framadate.org/NgnXl51S1sJMoJ2J)
...
1. The structure of the DMP. In discussion with Jorrit, we thought the first DMP should have more focus on the data management process and less on the data products.  I added some on that in the introduction, but it could be expanded and could be an own chapter, together with the model suggested by Jorrit.

2. Table 1 and 2 will not be included in this DMP, but we could use it for version 2?

3. We need to work more on chapter 3 (on the FAIR principles), eg making data interoperable. The setup of subchapters is a little frustrating, there are many overlaps, so maybe we should merge all the subchapters of 3 into one?

4. **Important:** I will be on holidays week 27 and 28, could anyone of you continue to work on the document in the meantime?
...
* LD: This is going to be the 1st version of DMP. Process is more important than what type of data we have and what type of data we will have. This DMP needs to detail how we will do the data management.  
...
* LD: It should not be one person’s responsibility. Maybe task leaders. We need to clarify this point in the DMP, re: who has what responsibility.  
...
* LB: Not really. “Willingness to pay” is always called that, but no standard name for every variable.   
  ...
  * **Metadata is the common base for all the data we will work with.** We can make rules for the metadata and be descriptive there.  
...
* NG:   
  * Before data is written down, it is a recording. It will be transcribed from an audio recording. Not simple. It can also be a video. These types of data should be mentioned in the DMP.   
  ...
  * Not easy to share such a huge file\! This must be addressed in the DMP.  
...
* JP:   
  ...
  * Make a list of all the various data we are interested in with a very short description and names of people who will be dealing with that data. How do we do this?  
...
* NG:   
  ...
  * NG is also part of WP3. They should discuss how to create this data table.  
* JvdS:   
...
* LD: **We should highlight this co-creation / review process in this first version of the DMP**. See notes (comments in the DMP document).  
...
* LB:  
  * Good to make a point of monthly or quarterly meetings in the DMP. Say that all these processes will be decided as data is collected.  
  * Lorraine was asked (in an ethics approval application she made) to hold workshops with partners to outline their responsibilities.  
  * In terms of reusability of the data, we will ensure human participants will be asked to give informed consent about the use of their data in the future / future projects.   
  * **Concent form: LB to add directly or send it to us by email**.  
...
* NK: 
  ...
  * We can treat this 1st version as a clean, presentable draft DMP and in it say that we will update it every 3-months internally.

* LD: 

  * Jeroen (Nilgun) to work io the DMP while LD is away.    
  * Nicolo to complete the data registry table (two example datasets, one highly regulated, one easier. See JP’s comment below).  
  * Anyone can add to the document (link above).
...
* Fill in the poll to find the best date in the **first week of August (please answer before July 11, Friday)**:

[https://framadate.org/NgnXl51S1sJMoJ2J](https://framadate.org/NgnXl51S1sJMoJ2J)
